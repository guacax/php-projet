...
<html lang="fr">
    ...
    <h1><?=$championDetails['name']?></h1>
        ...
        <?php
            // Afficher les informations détaillées du champion
            echo "ID: " . $championDetails['id'] . "<br>";
            echo "Nom: " . $championDetails['name'] . "<br>";
            echo "Titre: " . $championDetails['title'] . "<br>";
            echo "Blurb: " . $championDetails['blurb'] . "<br>";
        ...
        foreach ($skins as $skinKey => $skin) {
            ...
            <img src="https://ddragon.leagueoflegends.com/cdn/img/champion/loading/<?=$championDetails['id']?>_<?=$skin['num']?>.jpg">
            <?php
        }
